...
def read_pdf(request):
    ...
    with open(pdf_path, 'rb') as file:
        ...
        content = ""
        print("Nombre de page = {pdf_reader.pages}")
    ...
    for command in commands:
        ...
        produit_similaire = trouver_produit_similaire(command[2].strip())
        ...
        prix_facture = prix_facture.replace(',', '.')
        ...
        formatted_command = {
            ...
            "Commande": command[0].strip(),
            "Référence": command[1].strip(),
            "Produit": command[2].strip().replace("FR", ""),
